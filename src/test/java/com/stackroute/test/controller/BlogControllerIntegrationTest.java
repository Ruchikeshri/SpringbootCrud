...
public class BlogControllerIntegrationTest {
    ...
    @Test
    void givenBlogToSaveThenThrowException() throws BlogAlreadyExistsException, BlogAlreadyExistsException {
        assertNotNull(blogService.saveBlog(blog));
        assertThrows(BlogAlreadyExistsException.class, () -> blogService.saveBlog(blog));
    }

    @Test
    void givenBlogToDeleteThenShouldReturnTheDeletedBlog() throws BlogNotFoundException, BlogNotFoundException, BlogAlreadyExistsException {
        assertNotNull(blogService.saveBlog(blog));
